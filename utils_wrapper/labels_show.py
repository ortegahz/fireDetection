...
def parse_args():
    ...
    parser.add_argument('--imgs_dir_in', default='/home/manu/tmp/personne/images/train')
    parser.add_argument('--labels_dir_in', default='/home/manu/tmp/personne/labels/train')
