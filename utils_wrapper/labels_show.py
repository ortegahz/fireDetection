...
def parse_args():
    ...
    parser.add_argument('--imgs_dir_in', default='/home/manu/mnt/8gpu_3090/person_sorted/images/train')
    parser.add_argument('--labels_dir_in', default='/home/manu/mnt/8gpu_3090/person_sorted/labels/train')
